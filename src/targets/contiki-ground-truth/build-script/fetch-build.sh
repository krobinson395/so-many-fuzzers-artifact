...
git clone https://github.com/krobinson395/makefile.git ${SOFTWARE_PATH}/fix_for_makefile
...
#echo -e "${RED}Finished Fetch Build${NC}" >> /home/robin489/researchTools/so-many-fuzzers-artifact/buildConfirm.txt
